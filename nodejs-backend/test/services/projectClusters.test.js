...
describe("projectClusters service", () => {
  ...
  describe("#create", () => {
    const options = {"projectId":"new value","clusterName":"new value","tierName":"new value","provider":"new value","region":"new value","status":"new value"};
...
assert.strictEqual(projectClusterCreated.status, options.status);
  ...
  describe("#update", () => {
    ...
    const options = {"projectId":"updated value","clusterName":"updated value","tierName":"updated value","provider":"updated value","region":"updated value","status":"updated value"};
