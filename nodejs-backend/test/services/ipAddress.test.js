...
describe("ipAddress service", () => {
  ...
  describe("#create", () => {
    const options = {"projectId":"new value","ipAddress":"new value","status":"new value"};
...
assert.strictEqual(ipAddressCreated.status, options.status);
  ...
  describe("#update", () => {
    ...
    const options = {"projectId":"updated value","ipAddress":"updated value","status":"updated value"};
