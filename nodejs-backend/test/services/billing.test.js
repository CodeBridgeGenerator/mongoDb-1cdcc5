...
describe("billing service", () => {
  ...
  describe("#create", () => {
    const options = {"projectId":"new value","tierName":"new value","billingCycle":"new value","status":"new value","invoiceId":"new value"};
...
assert.strictEqual(billingCreated.invoiceId, options.invoiceId);
  ...
  describe("#update", () => {
    let billingUpdated;
    const options = {"projectId":"updated value","tierName":"updated value","billingCycle":"updated value","status":"updated value","invoiceId":"updated value"};
