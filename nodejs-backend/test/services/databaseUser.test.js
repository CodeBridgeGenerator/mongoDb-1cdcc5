...
describe("databaseUser service", () => {
  ...
  describe("#create", () => {
    const options = {"userId":"new value","projectId":"new value","mongodbUser":"new value","mongodbPassword":"new value","role":"new value"};
...
assert.strictEqual(databaseUserCreated.role, options.role);
  ...
  describe("#update", () => {
    ...
    const options = {"userId":"updated value","projectId":"updated value","mongodbUser":"updated value","mongodbPassword":"updated value","role":"updated value"};
