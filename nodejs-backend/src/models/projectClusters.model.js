...
clusterName: { type:  String , minLength: 2, maxLength: 999, index: true, trim: true, comment: "cluster_name, p, false, true, true, true, true, true, true, , , , ," },
tierName: { type:  String , maxLength: 150, index: true, trim: true, comment: "tier_name, p, false, true, true, true, true, true, true, , , , ," },
