const { Tiers } = require("./tiers.class");
const createModel = require("../../models/tiers.model");
const hooks = require("./tiers.hooks");
...
module.exports = function (app) {
  ...
  app.use("/tiers", new Tiers(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("tiers");

  // Get the schema of the collections 
  app.get("/tiersSchema", function (request, response) {
