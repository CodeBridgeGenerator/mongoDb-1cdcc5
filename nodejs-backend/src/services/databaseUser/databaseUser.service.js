const { DatabaseUser } = require("./databaseUser.class");
const createModel = require("../../models/databaseUser.model");
const hooks = require("./databaseUser.hooks");
...
module.exports = function (app) {
  ...
  app.use("/databaseUser", new DatabaseUser(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("databaseUser");

  // Get the schema of the collections 
  app.get("/databaseUserSchema", function (request, response) {
