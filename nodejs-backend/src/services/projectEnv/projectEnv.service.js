const { ProjectEnv } = require("./projectEnv.class");
const createModel = require("../../models/projectEnv.model");
const hooks = require("./projectEnv.hooks");
...
module.exports = function (app) {
  ...
  app.use("/projectEnv", new ProjectEnv(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("projectEnv");

  // Get the schema of the collections 
  app.get("/projectEnvSchema", function (request, response) {
