const { ProjectClusters } = require("./projectClusters.class");
const createModel = require("../../models/projectClusters.model");
const hooks = require("./projectClusters.hooks");
...
module.exports = function (app) {
  ...
  app.use("/projectClusters", new ProjectClusters(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("projectClusters");

  // Get the schema of the collections 
  app.get("/projectClustersSchema", function (request, response) {
