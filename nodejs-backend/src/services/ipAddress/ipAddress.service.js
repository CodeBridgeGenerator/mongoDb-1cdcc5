const { IpAddress } = require("./ipAddress.class");
const createModel = require("../../models/ipAddress.model");
const hooks = require("./ipAddress.hooks");
...
module.exports = function (app) {
  ...
  app.use("/ipAddress", new IpAddress(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("ipAddress");

  // Get the schema of the collections 
  app.get("/ipAddressSchema", function (request, response) {
