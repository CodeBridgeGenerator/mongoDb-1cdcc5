...
const ProjectClustersDataTable = ({
  items,
  fields,
  onEditRow,
  onRowDelete,
    ...
    <>
      ...
      >
        ...
        <Column
          ...
          header="cluster_name"
          body={pTemplate1}
          filter={selectedFilterFields.includes("clusterName")}
          hidden={selectedHideFields?.includes("clusterName")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
        ...
        <Column
          ...
          header="provider"
          body={pTemplate3}
          filter={selectedFilterFields.includes("provider")}
          hidden={selectedHideFields?.includes("provider")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
          ...
          header="region"
          body={pTemplate4}
          filter={selectedFilterFields.includes("region")}
          hidden={selectedHideFields?.includes("region")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
      ...
      <Dialog
        header="Upload ProjectClusters Data"
        visible={showUpload}
