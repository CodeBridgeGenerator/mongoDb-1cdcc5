...
import seederData from "./projectClusters.seeder.json";
...
const ProjectClustersSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ProjectClustersSeederDialogComponent);
