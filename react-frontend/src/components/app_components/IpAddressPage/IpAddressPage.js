    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "Ip Address",
          type: "error",
          message: error.message || "Failed get Ip Address",
        });
      });
