...
import seederData from "./ipAddress.seeder.json";
...
const IpAddressSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(IpAddressSeederDialogComponent);
