    ...
    <>
      ...
      >
        ...
        <Column
          ...
          header="ip_address"
          body={pTemplate1}
          filter={selectedFilterFields.includes("ipAddress")}
          hidden={selectedHideFields?.includes("ipAddress")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
