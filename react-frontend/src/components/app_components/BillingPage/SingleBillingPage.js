        ...
        <div className="col-12">
          ...
          <div className="card w-full">
            <div className="grid ">
              ...
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">billing_cycle</label>
                <p className="m-0 ml-3">{_entity?.billingCycle}</p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
              ...
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">invoice_id</label>
                <p className="m-0 ml-3">{_entity?.invoiceId}</p>
              </div>
