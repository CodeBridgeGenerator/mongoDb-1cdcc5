...
<Column field="tierName" header="Tier Name" body={pTemplate1} filter={selectedFilterFields.includes("tierName")} hidden={selectedHideFields?.includes("tierName")}  sortable style={{ minWidth: "8rem" }} />
<Column field="billingCycle" header="Billing Cycle" body={pTemplate2} filter={selectedFilterFields.includes("billingCycle")} hidden={selectedHideFields?.includes("billingCycle")}  sortable style={{ minWidth: "8rem" }} />
...
<Column field="invoiceId" header="Invoice ID" body={pTemplate4} filter={selectedFilterFields.includes("invoiceId")} hidden={selectedHideFields?.includes("invoiceId")}  sortable style={{ minWidth: "8rem" }} />
