...
import seederData from "./billing.seeder.json";
...
const BillingSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(BillingSeederDialogComponent);
