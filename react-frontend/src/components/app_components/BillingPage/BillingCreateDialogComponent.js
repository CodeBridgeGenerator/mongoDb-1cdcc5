  ...
  const onSave = async () => {
    ...
    try {
      ...
      props.alert({
        type: "success",
        title: "Create info",
        message: "Info Billing created successfully",
      });
      ...
      props.alert({
        type: "error",
        title: "Create",
        message: "Failed to create in Billing",
      });
    }
    setLoading(false);
  };
  ...
  return (
    ...
    >
      <div
        ...
        style={{ maxWidth: "55vw" }}
        role="billing-create-dialog-component"
      >
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="billingCycle"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.billingCycle}
              onChange={(e) => setValByKey("billingCycle", e.target.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="invoiceId"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.invoiceId}
              onChange={(e) => setValByKey("invoiceId", e.target.value)}
            />
          </span>
          <small className="p-error">
