    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "Billing",
          type: "error",
          message: error.message || "Failed get Billing",
        });
      });
