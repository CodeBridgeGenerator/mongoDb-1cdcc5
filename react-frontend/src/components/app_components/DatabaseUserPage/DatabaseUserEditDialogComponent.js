...
role: _entity?.role,
        ...
        const result = await client.service("databaseUser").patch(_entity._id, _data);
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info databaseUser updated successfully" });
    ...
    return (
        <Dialog header="Edit Database User" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="databaseUser-edit-dialog-component">
