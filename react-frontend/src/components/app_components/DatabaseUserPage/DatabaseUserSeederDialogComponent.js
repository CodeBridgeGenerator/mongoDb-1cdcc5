...
import seederData from "./databaseUser.seeder.json";
...
const DatabaseUserSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(DatabaseUserSeederDialogComponent);
