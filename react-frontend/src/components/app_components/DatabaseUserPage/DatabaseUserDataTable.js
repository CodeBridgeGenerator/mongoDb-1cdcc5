    ...
    <>
      ...
      >
        ...
        <Column
          ...
          header="mongodb_user"
          body={pTemplate2}
          filter={selectedFilterFields.includes("mongodbUser")}
          hidden={selectedHideFields?.includes("mongodbUser")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
          field="mongodbPassword"
          header="mongodb_password"
          body={pTemplate3}
          filter={selectedFilterFields.includes("mongodbPassword")}
          hidden={selectedHideFields?.includes("mongodbPassword")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
      ...
      <Dialog
        header="Upload DatabaseUser Data"
        visible={showUpload}
