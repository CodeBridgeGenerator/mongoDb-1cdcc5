...
const DatabaseUserPage = (props) => {
    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "Database User",
          type: "error",
          message: error.message || "Failed get Database User",
        });
      });
  ...
  const deleteAll = async () => {
    ...
    const promises = data.map((e) =>
      client.service("databaseUser").remove(e._id),
    );
    await Promise.all(
      promises.map((p) =>
        p.catch((error) => {
