...
const ProjectEnvPage = (props) => {
    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "Project Env",
          type: "error",
          message: error.message || "Failed get Project Env",
        });
      });
  ...
  const deleteAll = async () => {
    ...
    const promises = data.map((e) =>
      client.service("projectEnv").remove(e._id),
    );
    await Promise.all(
      promises.map((p) =>
        p.catch((error) => {
