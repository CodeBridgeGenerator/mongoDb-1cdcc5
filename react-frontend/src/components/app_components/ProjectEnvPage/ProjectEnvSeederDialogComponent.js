...
import seederData from "./projectEnv.seeder.json";
...
const ProjectEnvSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ProjectEnvSeederDialogComponent);
