...
const pTemplate1 = (rowData, { rowIndex }) => <p >{rowData.projectTitle}</p>
const pTemplate2 = (rowData, { rowIndex }) => <p >{rowData.projectDescription}</p>
...
<Column field="projectTitle" header="Project Title" body={pTemplate1} filter={selectedFilterFields.includes("projectTitle")} hidden={selectedHideFields?.includes("projectTitle")}  sortable style={{ minWidth: "8rem" }} />
<Column field="projectDescription" header="Project Description" body={pTemplate2} filter={selectedFilterFields.includes("projectDescription")} hidden={selectedHideFields?.includes("projectDescription")}  sortable style={{ minWidth: "8rem" }} />
