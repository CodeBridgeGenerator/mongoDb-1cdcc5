...
const ProjectsCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        if(!validate()) return;
        let _data = {
            projectID: _entity?.projectID,projectTitle: _entity?.projectTitle,projectDescription: _entity?.projectDescription,
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputText id="projectTitle" className="w-full mb-3 p-inputtext-sm" value={_entity?.projectTitle} onChange={(e) => setValByKey("projectTitle", e.target.value)}  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputText id="projectDescription" className="w-full mb-3 p-inputtext-sm" value={_entity?.projectDescription} onChange={(e) => setValByKey("projectDescription", e.target.value)}  />
            </span>
            <small className="p-error">
            {!_.isEmpty(error["projectDescription"]) ? (
              <p className="m-0" key="error-projectDescription">
